...
// // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
// // TEST_F(PlatoTestPythonApp, CrazyOptimiSMAttempt)
// // {
// //     std::vector<std::string> tFileContents = {
// //         "<?xml version=\"1.0\"?> \n",
// //         "<Operation> \n",
// //         "  <Function>ComputeCriterionValue</Function> \n",
// //         "  <Name>ComputeObjectiveValue</Name> \n",
// //         "  <PyModule>esp_plato_interface</PyModule> \n",
// //         "  <PyFunction>get_objective</PyFunction> \n",
// //         "  <PyPath>/home/ralberd/optimism/runs/window_interface</PyPath> \n",
// //         "  <PyPath>/home/ralberd/optimism/optimism</PyPath> \n",
// //         "  <PyPath>/home/ralberd/optimism/optimism/venv/lib/python3.9/site-packages</PyPath> \n",
// //         "  <Output> \n",
// //         "    <ArgumentName>Objective Value</ArgumentName> \n",
// //         "  </Output> \n",
// //         "</Operation> \n",
...
// //         "  <Name>ComputeObjectiveGradient</Name> \n",
// //         "  <PyModule>esp_plato_interface</PyModule> \n",
// //         "  <PyFunction>get_gradient</PyFunction> \n",
// //         "  <PyPath>/home/ralberd/optimism/runs/window_interface</PyPath> \n",
// //         "  <PyPath>/home/ralberd/optimism/optimism</PyPath> \n",
// //         "  <PyPath>/home/ralberd/optimism/optimism/venv/lib/python3.9/site-packages</PyPath> \n",
// //         "  <Output> \n",
...
// //     tSharedData.getData(tReturnVals);
// //     ASSERT_EQ(tReturnVals.size(), 1);
// //     EXPECT_NEAR(tReturnVals[0], 0.19689944739, 1.0e-8);

// //     tApp->compute("ComputeObjectiveGradient");
// //     bool tIsDynamic = true;
// //     Plato::SharedValue tSharedDataGrad("dumbo", {"nada"}, tDummyCommData, Plato::data::SCALAR, 1, tIsDynamic);
// //     tApp->exportData("DFDX", tSharedDataGrad);

// //     std::vector<double> tReturnGrad;
// //     tSharedDataGrad.getData(tReturnGrad);
// //     ASSERT_EQ(tReturnGrad.size(), 1900);
// //     EXPECT_NEAR(tReturnGrad[0], -2.17282456e-02, 1.0e-8);
// //     EXPECT_NEAR(tReturnGrad[1], 4.98066273e-02, 1.0e-8);
// //     EXPECT_NEAR(tReturnGrad[2], 4.18473268e-03, 1.0e-8);
// //     EXPECT_NEAR(tReturnGrad[5], 1.34435445e-02, 1.0e-8);
