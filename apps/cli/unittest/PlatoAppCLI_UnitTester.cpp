...
public:
    ...
    **********************************************************************************/
        ...
        mLocalComm(aLocalComm)
    {
        ...
        {
            THROWERR("PLATO_APP_FILE keyword is empty. An input file must be provided to the Plato CLI App.")
        }
    }
...
private:
    AppCLI(const PlatoAppCLI::AppCLI& aRhs);
    PlatoAppCLI::AppCLI& operator=(const PlatoAppCLI::AppCLI& aRhs);
};
// class AppCLI
