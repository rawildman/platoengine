...
TEST(ConstraintFactory, ValidConstraint)
{
    ...
    const process_manager::library::ValidatedInput tData = process_manager::library::parse_and_validate(
        tConstraintInput + tGeometryInput + tOptimizerInput + tObjectiveInput);
