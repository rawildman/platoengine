...
[[nodiscard]] std::vector<library::GeometryInput> geometry_blocks_impl(const Plato::PlatoInput& aInput,
...
[[nodiscard]] std::vector<library::GeometryInput> geometry_blocks(const Plato::PlatoInput& aInput);
...
[[nodiscard]] std::optional<library::GeometryInput> first_geometry_block(const Plato::PlatoInput& aInput);
