...
double AbstractKernelThenProjection::internal_apply(AbstractInterface::ParallelVector* const field, const int& i) const
{
    return projection_apply(m_current_heaviside_parameter, field->get_value(i));
}
