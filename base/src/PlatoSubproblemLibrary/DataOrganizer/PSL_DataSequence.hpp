...
/* Data Sequences have an assortment of plain old data available
 * and able to be mutated/extended. The main intention of data sequences
 * is to allow immediate writing to file, and reading from file.
 */
