...
/* Iterative Selection is based loosely on an evolutionary algorithm for
 * global optimization. Through a certain number of stages (epochs), a full
 * discrete space is progressively decreased to arrive at the best (least)
 * objective value.
 */
