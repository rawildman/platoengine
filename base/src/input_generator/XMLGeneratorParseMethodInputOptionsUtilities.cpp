...
void insert_rol_input_options(XMLGen::MetaDataTags &aTags)
{
    ...
    aTags.insert({ "rol_initial_trust_region_radius", { { {"rol_initial_trust_region_radius"}, ""}, "0.5" } });
    ...
    aTags.insert({ "rol_gradient_tolerance", { { {"rol_gradient_tolerance"}, ""}, "1e-6" } });
    aTags.insert({ "rol_constraint_tolerance", { { {"rol_constraint_tolerance"}, ""}, "1e-6" } });
    aTags.insert({ "rol_step_tolerance", { { {"rol_step_tolerance"}, ""}, "1e-6" } });
