/*
 * XMLGeneratorSalinasOperationsFileUtilities.cpp
 *
...
*/
#include "XMLGeneratorSalinasOperationsFileUtilities.hpp"
...
void write_salinas_operation_xml_file
...
*/
    ...
    std::string tFilename = std::string("salinas_") + tServiceID + "_operations.xml";
